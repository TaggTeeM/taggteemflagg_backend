...
export abstract class DALBaseModel extends BaseEntity {
    ...
    @Column({
        type: 'tinyint', width: 1, default: 1, transformer: {
    ...
    constructor() {
        ...
        this.createDate = new Date();  // Default createDate to the current date
        this.lastUpdated = new Date();  // Default lastUpdated to the current date
    }
}
