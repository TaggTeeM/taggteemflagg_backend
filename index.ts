...
dataSource
  ...
  .then(() =>
  {
    app.post('/api/validate-login', ThreeSecondLimiter, async (req, res) => validateLogin(req, res, dataSource));
    app.post('/api/validate-otp', async (req, res) => validateOTP(req, res, dataSource));
  
    app.post("/api/sign-up", TenSecondLimiter, async (req, res) => signUp(req, res, dataSource));
    app.post('/api/driver-signup', async (req, res) => driverSignup(req, res, dataSource));
  
    app.post('/api/get-preferred-drivers', async (req, res) => getPreferredDrivers(req, res, dataSource));
    app.post('/api/trip-cost-list', async (req, res) => tripCostList(req, res, dataSource));
